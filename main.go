...
func init() {
	...
	codeCmd.Flags().StringSliceVarP(&config.Volumes, "volume", "v", []string{}, "Mount a volumes to newly created execs. e.g., -v <volume-name>:/data")
	...
	newCmd.Flags().StringSliceVarP(&config.Volumes, "volume", "v", []string{}, "Mount volumes to the exec. e.g., -v <volume-name>:/data")
	...
	sshCmd.Flags().StringSliceVarP(&config.Volumes, "volume", "v", []string{}, "Mount a volumes to newly created execs. e.g., -v <volume-name>:/data")
